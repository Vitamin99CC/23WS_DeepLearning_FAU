...
# with one layer we can approximate any function with proper activation function
# multi-layer: fewer neuron = more efficient 
# more layers non continuous functions XOR problem